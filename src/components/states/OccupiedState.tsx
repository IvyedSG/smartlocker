import { Lock, Key, X, AlertCircle, Package, Mail } from 'lucide-react';
    ...
    <div className="w-full max-w-2xl">
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-blue-700 text-lg">
              Se envió un PIN de 4 dígitos al correo: <strong>{email}</strong>.
      ...
      <div className="space-y-4 mb-10">
        <label htmlFor="pin" className="block text-gray-700 text-2xl font-medium flex items-center gap-3">
          <Lock className="text-gray-600 w-8 h-8" /> Ingrese el PIN de 4 dígitos:
        </label>
